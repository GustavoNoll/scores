...
describe('FieldScoreRuleService', () => {
  ...
  it('should return a validation error for invalid data', async () => {
    ...
    expect(response.message).toEqual({
      "message": "\"field\" must be one of [uptime, txPower, cpuUsage, memoryUsage, rxPower, temperature, totalConnectedDevices, connectedDevices5GRatio, averageWorstRssi, rebootCount]"
  })
  });
